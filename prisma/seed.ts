    ...
    try {
      ...
      await prisma.paySlip.create({
        data: {
          ...
          nightHours: new Prisma.Decimal((input.attendance.nightHours ?? 0).toFixed(2)),
          otWeekdayHours: new Prisma.Decimal((input.attendance.otWeekdayHours ?? 0).toFixed(2)),
          otWeekendHours: new Prisma.Decimal((input.attendance.otWeekendHours ?? 0).toFixed(2)),
          otHolidayHours: new Prisma.Decimal((input.attendance.otHolidayHours ?? 0).toFixed(2)),
